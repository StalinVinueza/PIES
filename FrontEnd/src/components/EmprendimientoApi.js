...
import EmprendimientosList from "./EmprendimientoList";
...
function EmprendimientosApi() {
  ...
  const handleShowModal = (emprendimiento = {}) => {
    setEditData({
      ...
      es_emp_categoria: emprendimiento.es_emp_categoria || "",
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("es_emp_categoria", editData.es_emp_categoria);
  ...
  return (
    <div className="container">
      ...
      <EmprendimientosList emprendimientos={emprendimientos} onShowModal={handleShowModal} />
